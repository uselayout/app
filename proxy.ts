...
const PUBLIC_PATHS = ["/login", "/signup", "/request-access", "/forgot-password", "/reset-password", "/api/", "/docs", "/downloads", "/pricing", "/invite", "/showcase", "/terms", "/privacy", "/changelog", "/roadmap", "/unavailable", "/gallery", "/vs", "/spec"];
