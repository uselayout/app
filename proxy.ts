...
const PUBLIC_PATHS = ["/login", "/signup", "/request-access", "/forgot-password", "/reset-password", "/api/", "/docs", "/pricing", "/invite", "/showcase", "/terms", "/privacy", "/changelog", "/roadmap", "/unavailable", "/vs", "/spec"];
