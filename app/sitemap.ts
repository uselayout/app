...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/ui`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${baseUrl}/vs/shadcn`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/vs/design-md`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
