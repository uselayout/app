...
const OBJECTIONS: Objection[] = [
  ...
  },
  {
    ...
    answer:
      "They import your design system into their canvas. Layout exports it into your IDE. They generate prototypes you screenshot and hand off. Layout generates context that makes Claude Code, Cursor, and Copilot produce on-brand code directly in your codebase. No copy-paste. No handoff gap.",
  },
  {
    ...
    <div className="space-y-10">
      ...
      <section className="rounded-xl border border-gray-200 bg-gray-50 px-5 py-4 space-y-2">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          ...
          Claude Code, Cursor, Copilot, or Windsurf). Your designers stay in
