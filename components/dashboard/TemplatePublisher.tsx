      ...
      <div className="flex items-center justify-between">
        ...
        {!showCreateForm && (
          <button
            ...
            className="rounded-lg bg-[var(--studio-accent)] px-4 py-2 text-sm font-medium text-[var(--text-on-accent)] transition-colors duration-[var(--duration-base)] hover:bg-[var(--studio-accent-hover)]"
          >
            Create Template
          </button>
        )}
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                disabled={submitting}
                className="rounded-lg bg-[var(--studio-accent)] px-4 py-2 text-sm font-medium text-[var(--text-on-accent)] transition-colors duration-[var(--duration-base)] hover:bg-[var(--studio-accent-hover)] disabled:opacity-50"
              >
